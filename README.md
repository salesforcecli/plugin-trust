...
_See code: [src/commands/plugins/trust/allowlist/add.ts](https://github.com/salesforcecli/plugin-trust/blob/3.8.36/src/commands/plugins/trust/allowlist/add.ts)_
...
_See code: [src/commands/plugins/trust/allowlist/list.ts](https://github.com/salesforcecli/plugin-trust/blob/3.8.36/src/commands/plugins/trust/allowlist/list.ts)_
...
_See code: [src/commands/plugins/trust/allowlist/remove.ts](https://github.com/salesforcecli/plugin-trust/blob/3.8.36/src/commands/plugins/trust/allowlist/remove.ts)_
...
_See code: [src/commands/plugins/trust/verify.ts](https://github.com/salesforcecli/plugin-trust/blob/3.8.36/src/commands/plugins/trust/verify.ts)_
